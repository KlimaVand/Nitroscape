...
void message::FatalError(const char * cp1,const double adouble, const char * cp3)
{
	char *cp2;
	sprintf(cp2,"%f",adouble);
	FatalError(cp1, cp2, cp3);
}

void message::FatalError(const char * cp1,const int anint, const char * cp3)
{
	char *cp2;
	sprintf(cp2,"%d",anint);
	FatalError(cp1, cp2, cp3);
