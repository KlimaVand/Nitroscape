...
class fieldOpTill  : public fieldOp
{
  ...
  //! Depth to which the soil should be tilled (metres)
     double depth; //Attribute data member (metres)
...
*/
   void DefineOp(char * aName, int aNumber, int Year, int Month, int Day, double tillageDepth);
...
\param tillageDepth depth of the tillage operation (metres)
*/
	void DefineOp(char * aName, int aNumber, int Year, int JulianDay, double tillageDepth);
