...
{                       
	...
	bool zeroTillage;
	//!Cumulative amount of N added to the NCU
	double N_added;
	//!Maximum number of fields in the simulation
	int maxFields;
...
public:
    ...
    * \param readAll if true,  all NCUs will be read
	...
	void checkSlurryOperations(cropSeriesClass * acropSeriesClass, NCUCropClass *aNCUCropClass, int calendarYear);
