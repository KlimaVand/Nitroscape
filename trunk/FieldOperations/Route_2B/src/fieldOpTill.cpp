...
void fieldOpTill::DefineOp(char * aName, int aNumber, int Year, int Month, int Day, double tillageDepth)
{
	fieldOp::DefineOp(aName,  aNumber, Year, Month, Day);
   depth=tillageDepth;
}

void fieldOpTill::DefineOp(char * aName, int aNumber, int Year, int JulianDay, double tillageDepth)
{
