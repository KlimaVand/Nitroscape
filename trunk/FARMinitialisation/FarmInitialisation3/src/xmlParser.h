/*! \mainpage Nitroscape FARM initialisation
 *
 * This program interrogates the XML file management.xml and extracts the data necessary
 * to initialise the FARM module in Nitroscape.
 *
 * Note: some of the functions within the classes included here are designed to assist
 * in the generation of field operation files for Component 5 of the NitroEurope project.
 *
 *
 *This program uses the following XML parser library:
 *
 *
 *
 * \section XMLParser_library
 ...
 *
 * \subsection tutorial First Tutorial
 * You can follow a simple <a href="../../xmlParser.html">Tutorial</a> to know the basics...
 *
 * \subsection usage General usage: How to include the XMLParser library inside your project.
 *
 ...
 *
 * \subsection example Advanced Tutorial and Many Examples of usage.
 *
 ...
 * - windows: Visual Studio: float-click on xmlParser.dsw
 ...
 *
 * \subsection debugging Debugging with the XMLParser library
 *
 * \subsubsection debugwin Debugging under WINDOWS
 *
 ...
 * "tweaks" that improve substantially the display of the content of the XMLNode objects
 ...
 *
 * \subsubsection debuglinux Debugging under LINUX/UNIX
 *
...
XMLDLLENTRY float  xmltof(XMLCSTR xmlString,float defautValue=.0);
