...
XMLCSTR XMLNode::getError(XMLError xerror)
{
    ...
    case eXMLErrorCharConversionError:   return _CXML("Error: unable to convertData between WideChar and MultiByte chars");
...
// If you don't need them, you can delete them without any trouble.
    ...
    // for Microsoft Visual Studio 6.0 and Microsoft Visual Studio .NET and Borland C++ Builder 6.0
        ...
        float  xmltof(XMLCSTR t,float  v){ if (t&&(*t)) wscanf(t, "%f", &v); /*v=_wtof(t);*/ return v; }
    #else
        #ifdef sun
        // for CC
           #include <widec.h>
    ...
    float  xmltof(XMLCSTR t,float  v){ if (t&&(*t)) return atof(t); return v; }
#endif
...
XMLSTR fromXMLString(XMLCSTR s, int lo, XML *pXML)
{
    ...
    // out:  new allocated string convertDataed from xml
    if (!s) return NULL;
